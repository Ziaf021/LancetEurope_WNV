...
cbind(
    ...
    mutate( Abs_prcnt_risk_first_second_Half = round(((mean_prob_2013to2022-mean_prob_1951to1960))*100,2))%>%
    mutate( Rel_prcnt_risk_first_second_Half = round(((mean_prob_2013to2022-mean_prob_1951to1960)/mean_prob_1951to1960)*100,2))

 write.csv(df_AbsChangeRisk, file= "LCDE24_WNV_PrcntChngRisk_comparisons.csv")
...
read.csv("/Users/ziafarooq/Old_Mac/Umu_PhD/LCD_Europe/LCD24_WNVMainFig_EuRegs.csv")%>%
 #df_Mean_risk_EU_RegWise%>%
   filter( EU_reg != "All Europe" & year != 1950)%>%
 ggplot(aes(year , 
            m_prob, color=EU_reg))+
